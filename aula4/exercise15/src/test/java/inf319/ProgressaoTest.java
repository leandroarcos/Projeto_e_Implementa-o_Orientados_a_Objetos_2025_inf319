...
public class ProgressaoTest extends TestCase { 
    ...
    public void testProgressaoQuadrada() {
    	Progressao pq = new ProgressaoQuadrada(new ProgressaoAritmetica());
    	assertEquals(0, pq.inicia());
        assertEquals(1, pq.proxTermo());
        assertEquals(4, pq.proxTermo());
        assertEquals(16, pq.iesimoTermo(4));
        assertEquals(36, pq.iesimoTermo(6));
        assertEquals("0 1 4 9 16 25 36 49 64 81 100\n",
                     pq.imprimeProgressao(10));
    }
